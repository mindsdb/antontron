...
Scans all known workspaces for output files.
"""
...
from .projects import discover_workspace_paths
...
def _scan_output_dirs() -> list[Path]:
    ...
    for workspace in discover_workspace_paths():
        output_dir = workspace / ".anton" / "output"
