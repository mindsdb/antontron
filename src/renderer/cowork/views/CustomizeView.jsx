    ...
    <div className="customize-view">
      <div className="customize-header">
        <button
          ...
          aria-label="Back"
          onClick={handleBack}
          disabled={!directoryMode && page === PAGE_HOME}
        >
          {Ico.chevLeft(16)}
        </button>
        <div className="customize-header-title">Customize</div>
      </div>

      <div className="customize-body">
        {page === PAGE_HOME && (
          <div className="customize-home-layout">
            <Subnav page={page} onPageChange={setPage} onOpenPlugins={() => openDirectory(DIRECTORY_MODE_PLUGINS)} />
            <HomePage onOpenDirectory={openDirectory} />
          </div>
        )}
